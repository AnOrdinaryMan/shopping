<template>
    <div style="margin-bottom: 520px;">
        <div v-for="(item, index) in shopCart" :key="index" class="shopCartItem" :class="{shopCartItemHover: item.checked}">
            <div class="inlineBlock" style="margin-right: 10px;">
                <input type="checkbox" name="shopCart" :value="index" @change="checkedHandle(index)">
            </div>
